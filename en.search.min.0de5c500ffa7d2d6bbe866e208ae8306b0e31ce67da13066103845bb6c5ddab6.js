...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b8d0e50d7b7ec528d63473153a3651e46ac0aad218e5dfb6144ccf9e16a41d82.js',function(){input.required=false;search();});}
