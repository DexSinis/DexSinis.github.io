...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.37fdcc4a8a536c7219c93784fab7cb3b9a9676d6cdbc85011b46a4ac051ea131.js',function(){input.required=false;search();});}
