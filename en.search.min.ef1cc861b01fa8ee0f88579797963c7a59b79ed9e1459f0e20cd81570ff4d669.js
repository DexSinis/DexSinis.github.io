...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8759d1bed8a4c7fadddaef66dae710860162256ea927e392dfb9bf429f45fa21.js',function(){input.required=false;search();});}
