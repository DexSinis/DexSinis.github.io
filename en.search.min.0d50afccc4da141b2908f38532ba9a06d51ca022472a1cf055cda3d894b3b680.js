...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.941574a8e23ef78c1b4d2723a45e4a6f6006f8575ebc5137a092e03a66ff5fec.js',function(){input.required=false;search();});}
